...
public class PostStruttura extends JFrame {
	...
	public PostStruttura(Controllore ctrl) {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Nessuno", "Pizzeria", "Braceria", "Enoteca", "Paninoteca", "Agriturismo", "Tosteria"}));
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Nessuno", "Pizzeria", "Braceria", "Enoteca", "Paninoteca", "Agriturismo", "Tosteria"}));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String tipologia_struttura = (String)comboBox_3.getSelectedItem();
				String descrizione = (String)testo_Descrizione.getText();
				Db database =new Db();
				database.connect();
				database.postaStrutturaQuery(nome, indirizzo, tipologia_struttura, descrizione);
