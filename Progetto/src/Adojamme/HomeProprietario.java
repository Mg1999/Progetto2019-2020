...
public class HomeProprietario extends JFrame {
	 ...
	 * Create the frame.
	 */
	public HomeProprietario(Controllore ctrl) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controllore.proprietarioProfilo();
			}
		});
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(201)
					.addComponent(label_logo, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
					.addGap(176)
